<?php /* Smarty version 2.6.14, created on 2012-02-26 19:14:08
         compiled from C:%5CUsers%5CDaniel%5CDesktop%5Cxxl%5Csys/templates/catalog/checkout.tpl */ ?>
<?php ob_start(); ?>
	<?php if (! empty ( $this->_tpl_vars['cart'] )): ?>
		...
		<form method="post" action="?module=catalog&action=checkout" name="checkout">
			...
			<fieldset>
				<label for="nome"><img src="images/label-pedido-nome.png" alt=""/></label>
				<input type="text" name="nome" id="nome" class="required"/>
				<br/>
				
				<label for="email"><img src="images/label-pedido-email.png" alt=""/></label>
				...
				<label for="telefone"><img src="images/label-pedido-telefone.png" alt=""/></label>
				<input type="text" name="telefone" id="telefone" class="required"/>
				<br/>
				
				<label for="cnpj"><img src="images/label-pedido-cnpj.png" alt=""/></label>
				<input type="text" name="cnpj" id="cnpj" class="required"/>
				<br/>
