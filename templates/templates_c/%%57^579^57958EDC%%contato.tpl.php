<?php /* Smarty version 2.6.14, created on 2011-12-17 21:05:23
         compiled from C:%5CUsers%5CDaniel%5CDesktop%5Cxxl%5Csys/templates/content/contato.tpl */ ?>
<?php ob_start(); ?>
	<form action="" method="post" name="contato" class="ajax-post">
		...
		<fieldset class="contato expand-fields">
			<div class="fields">
				...
				<label for="mensagem"><img src="images/field-mensagem.png"/></label>
				<textarea></textarea>
				<br/>
			</div>
			<div class="button">
...
$this->_smarty_include(array('smarty_include_tpl_file' => "content/template.tpl", 'smarty_include_vars' => array('page_name' => 'contato')));
